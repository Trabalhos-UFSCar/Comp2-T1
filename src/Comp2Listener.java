...
public class Comp2Listener extends LABaseListener {
    ...
    Escopos escopos;
    Map tipos;
    /*TODO: definir tipos para uso mais facil*/
     ...
     */
    @Override
    public void exitMais_var(LAParser.Mais_varContext ctx) {
     ...
     */
    @Override
    public void exitPonteiros_opcionais(LAParser.Ponteiros_opcionaisContext ctx) {
     ...
     */
    @Override
    public void exitOutros_ident(LAParser.Outros_identContext ctx) {
     ...
     */
    @Override
    public void exitMais_ident(LAParser.Mais_identContext ctx) {
     ...
     */
    @Override
    public void enterMais_variaveis(LAParser.Mais_variaveisContext ctx) {
     ...
     */
    @Override
    public void exitMais_variaveis(LAParser.Mais_variaveisContext ctx) {
     ...
     */
    @Override
    public void enterVar_opcional(LAParser.Var_opcionalContext ctx) {
     ...
     */
    @Override
    public void exitVar_opcional(LAParser.Var_opcionalContext ctx) {
     ...
     */
    @Override
    public void enterMais_parametros(LAParser.Mais_parametrosContext ctx) {
     ...
     */
    @Override
    public void exitMais_parametros(LAParser.Mais_parametrosContext ctx) {
     ...
     */
    @Override
    public void enterDeclaracoes_locais(LAParser.Declaracoes_locaisContext ctx) {
...
//            out.println(ctx.toStringTree());
     ...
     */
    @Override
    public void exitMais_expressao(LAParser.Mais_expressaoContext ctx) {
     ...
     */
    @Override
    public void exitArgumentos_opcional(LAParser.Argumentos_opcionalContext ctx) {
     ...
     */
    @Override
    public void enterMais_selecao(LAParser.Mais_selecaoContext ctx) {
     ...
     */
    @Override
    public void exitMais_selecao(LAParser.Mais_selecaoContext ctx) {
     ...
     */
    @Override
    public void enterMais_constantes(LAParser.Mais_constantesContext ctx) {
     ...
     */
    @Override
    public void exitMais_constantes(LAParser.Mais_constantesContext ctx) {
     ...
     */
    @Override
    public void enterIntervalo_opcional(LAParser.Intervalo_opcionalContext ctx) {
     ...
     */
    @Override
    public void exitIntervalo_opcional(LAParser.Intervalo_opcionalContext ctx) {
     ...
     */
    @Override
    public void enterOp_multiplicacao(LAParser.Op_multiplicacaoContext ctx) {
     ...
     */
    @Override
    public void exitOp_multiplicacao(LAParser.Op_multiplicacaoContext ctx) {
     ...
     */
    @Override
    public void enterOp_adicao(LAParser.Op_adicaoContext ctx) {
     ...
     */
    @Override
    public void exitOp_adicao(LAParser.Op_adicaoContext ctx) {
     ...
     */
    @Override
    public void enterOutros_termos(LAParser.Outros_termosContext ctx) {
     ...
     */
    @Override
    public void exitOutros_termos(LAParser.Outros_termosContext ctx) {
     ...
     */
    @Override
    public void enterOutros_fatores(LAParser.Outros_fatoresContext ctx) {
     ...
     */
    @Override
    public void exitOutros_fatores(LAParser.Outros_fatoresContext ctx) {
     ...
     */
    @Override
    public void enterOutras_parcelas(LAParser.Outras_parcelasContext ctx) {
     ...
     */
    @Override
    public void exitOutras_parcelas(LAParser.Outras_parcelasContext ctx) {
     ...
     */
    @Override
    public void enterOp_opcional(LAParser.Op_opcionalContext ctx) {
     ...
     */
    @Override
    public void exitOp_opcional(LAParser.Op_opcionalContext ctx) {
     ...
     */
    @Override
    public void enterOp_nao(LAParser.Op_naoContext ctx) {
     ...
     */
    @Override
    public void exitOp_nao(LAParser.Op_naoContext ctx) {
     ...
     */
    @Override
    public void enterOutros_termos_logicos(LAParser.Outros_termos_logicosContext ctx) {
     ...
     */
    @Override
    public void exitOutros_termos_logicos(LAParser.Outros_termos_logicosContext ctx) {
     ...
     */
    @Override
    public void enterOutros_fatores_logicos(LAParser.Outros_fatores_logicosContext ctx) {
     ...
     */
    @Override
    public void exitOutros_fatores_logicos(LAParser.Outros_fatores_logicosContext ctx) {
